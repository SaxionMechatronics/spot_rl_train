...
# def illegal_contact_after_n_steps(
#     env: ManagerBasedRLEnv,
#     threshold: float,
#     sensor_cfg: SceneEntityCfg,
#     n_steps: int,
# ) -> torch.Tensor:
#     """Terminate when the contact force exceeds threshold, but only after n_steps."""

#     contact_sensor: ContactSensor = env.scene.sensors[sensor_cfg.name]
#     net_contact_forces = contact_sensor.data.net_forces_w_history

#     # same force computation as before
#     illegal = torch.any(
#         torch.max(
...
#     # only activate after transition period
#     after_transition = env.episode_length_buf >= n_steps

#     return illegal & after_transition
